...
class WPCustomCategoryImage
{
    ...
    public function admin_enqueue_assets($hook)
    {
        ...
        wp_enqueue_media();
        echo 
        wp_enqueue_script('category-image-js', $this->asset_url('/category_select/js/categoryimage.js'), array('jquery'), '1.0.0', true );
        ...
        wp_enqueue_style('category-image-css', $this->asset_url('/category_select/css/categoryimage.css'));
    }

    private function asset_url($file)
    {
//        echo "file is " . __FILE__ . "<br>";
//        echo "returning plugin url " . plugins_url($file, __FILE__) . "<br>";
//        echo "Fixing the return value to " . get_template_directory_uri() . $file;
//        exit;
